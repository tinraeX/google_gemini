...
*   **Архитектура «Командир-Исполнитель»:**
    *   **Commander (Gemini 1.5 Pro):** Стратегический мозг, который анализирует собранные данные, строит гипотезы и разрабатывает многошаговые планы атак.
    *   **Worker (Gemini 1.5 Flash):** Тактический исполнитель, который выполняет команды, анализирует их вывод и сообщает о результатах Командиру.
